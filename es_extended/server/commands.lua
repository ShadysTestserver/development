...
ESX.RegisterCommand('setjob', 'user', function(xPlayer, args, showError)
	if ESX.DoesJobExist(args.job, args.grade) then
		args.playerId.setJob(args.job, args.grade, false)
	else
...
--[[ESX.RegisterCommand('setjobstaff', 'admin', function(xPlayer, args, showError)
	if ESX.DoesJobExist(args.job, args.grade) then
		args.playerId.setJob(args.job, args.grade, true)
	else
		showError(_U('command_setjob_invalid'))
	end
end, true, {help = _U('command_setjob'), validate = true, arguments = {
...
ESX.RegisterCommand('setjob2staff', 'admin', function(xPlayer, args, showError)
	if ESX.DoesJobExist(args.job, args.grade) then
		args.playerId.setJob(args.job, args.grade, true)
	else
		showError(_U('command_setjob_invalid'))
...
ESX.RegisterCommand('setjob2', 'user', function(xPlayer, args, showError)
	if ESX.DoesJobExist(args.job2, args.grade2) then
		args.playerId.setJob2(args.job2, args.grade2, false)
	else
		showError(_U('command_setjob_invalid'))
	end
end, true, {help = _U('command_setjob'), validate = true, arguments = {
...
ESX.RegisterCommand({'dv'}, 'user', function(xPlayer, args, showError)
	xPlayer.triggerEvent('esx:deleteVehicle', args.radius)
end, false, {help = _U('command_cardel'), validate = false, arguments = {}})

ESX.RegisterCommand({'dvf'}, 'admin', function(xPlayer, args, showError)
	xPlayer.triggerEvent('esx:deleteVehicle', args.radius)
end, false, {help = _U('command_cardel'), validate = false, arguments = {
	{name = 'radius', help = _U('command_cardel_radius'), type = 'any'}
}})

ESX.RegisterCommand({'delprop'}, 'admin', function(xPlayer, args, showError)
	xPlayer.triggerEvent('esx:deleteObject', args.radius)
end, false, {help = _U('command_cardel'), validate = false, arguments = {
	{name = 'radius', help = "Verwijder props in omgeving", type = 'any'}
}})

ESX.RegisterCommand({'delped'}, 'admin', function(xPlayer, args, showError)
	xPlayer.triggerEvent('esx:deletePed', args.radius)
end, false, {help = _U('command_cardel'), validate = false, arguments = {
	{name = 'radius', help = "Verwijder peds in omgeving", type = 'any'}
}})

ESX.RegisterCommand('setaccountmoney', 'user', function(xPlayer, args, showError)
...
ESX.RegisterCommand('giveaccountmoney', 'user', function(xPlayer, args, showError)
	if args.playerId.getAccount(args.account) then
...
ESX.RegisterCommand('giveitem', 'user', function(xPlayer, args, showError)
...
ESX.RegisterCommand('giveweapon', 'user', function(xPlayer, args, showError)
...
ESX.RegisterCommand('giveweaponcomponent', 'user', function(xPlayer, args, showError)
...
ESX.RegisterCommand('setgroup', 'grotestaff', function(xPlayer, args, showError)
...
ESX.RegisterCommand('verwijderloadout', 'user', function(xPlayer, args, showError)
    xPlayer.removeWeaponUser(0)
    for k,v in ipairs(xPlayer.loadout) do
        xPlayer.removeWeaponUser(v.name, 0)
    end
end, false, {help = _U('command_clearloadoutuser'), validate = true, arguments = {
}})